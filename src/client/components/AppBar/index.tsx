            ...
            <>
              <Drawer open={this.state.open} onClose={this.handleDrawerToggle}>
                <StyledList>
                  ...
                  <ListItem
                    button
                    onClick={this.handleListItemClick.bind(this, "/add-contact")}
                  >
                    <ListItemIcon>
                      <AddIcon />
                    </ListItemIcon>
                    <ListItemText primary={appBar.drawer.list.addContact} />
                  </ListItem>   
                  <ListItem
                    button
                    onClick={this.handleListItemClick.bind(this, "/contacts")}
                  >
                    <ListItemIcon>
                      <ListIcon />
                    </ListItemIcon>
                    <ListItemText primary={appBar.drawer.list.contacts} />
                  </ListItem>                                    
                </StyledList>
              </Drawer>
